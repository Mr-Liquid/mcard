# -*- coding: utf-8 -*-
# Generated by Django 1.11.4 on 2017-08-12 12:19
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('family', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='mcard.Family')),
                ('location', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='mcard.Location')),
            ],
        ),
        migrations.CreateModel(
            name='Transaction',
            fields=[
                ...
                ('product', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='mcard.Product')),
            ],
        ),
    ]
